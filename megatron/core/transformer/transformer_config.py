...
class TransformerConfig(ModelParallelConfig):
    ...
    norm_accuracy_compatible: bool = field(
        default=False,
        metadata={"argparse_meta": {"arg_names": ["--norm-accuracy-compatible"]}},
    )
    ...
    router_accuracy_compatible: bool = field(
        default=False,
        metadata={"argparse_meta": {"arg_names": ["--router-accuracy-compatible"]}},
    )
    ...
    dsa_accuracy_compatible: bool = field(
        default=False,
        metadata={"argparse_meta": {"arg_names": ["--dsa-accuracy-compatible"]}},
    )
